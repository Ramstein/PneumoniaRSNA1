...
class deform_conv_demo(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        if is_train:
            ...
            group = mx.sym.Group(
                [res5a_branch2b_offset, res5b_branch2b_offset, res5c_branch2b_offset, rois, cls_prob, bbox_pred])
    ...
    def get_symbol_rfcn(self, cfg, is_train=True):
        ...
        if is_train:
            ...
            bbox_pred = mx.sym.Reshape(data=bbox_pred, shape=(cfg.TEST.BATCH_IMAGES, -1, 4 * num_reg_classes),
                                       name='bbox_pred_reshape')
            group = mx.sym.Group(
                [res5a_branch2b_offset, res5b_branch2b_offset, res5c_branch2b_offset, cls_prob, bbox_pred])
