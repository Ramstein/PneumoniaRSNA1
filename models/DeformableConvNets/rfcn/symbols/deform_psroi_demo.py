...
class deform_psroi_demo(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        rfcn_bbox = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=3 * 3 * 4 * num_reg_classes,
                                       name="rfcn_bbox")
        # trans_cls / trans_cls
        rfcn_cls_offset_t = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=2 * 3 * 3 * num_classes,
                                               name="rfcn_cls_offset_t")
        rfcn_bbox_offset_t = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=3 * 3 * 2,
                                                name="rfcn_bbox_offset_t")

        rfcn_cls_offset = mx.contrib.sym.DeformablePSROIPooling(name='rfcn_cls_offset', data=rfcn_cls_offset_t,
                                                                rois=rois, group_size=3, pooled_size=3,
                                                                sample_per_part=4, no_trans=True, part_size=3,
        ...
        psroipooled_cls_rois = mx.contrib.sym.DeformablePSROIPooling(name='psroipooled_cls_rois', data=rfcn_cls,
                                                                     ...
                                                                     group_size=3, pooled_size=3, sample_per_part=4,
