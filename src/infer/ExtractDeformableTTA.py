...
parser.add_argument("RFCN_DETS_DIR", type=str, nargs="?",
                    default="../../models/DeformableConvNets/skpeep/unfreeze/output/{}/rfcn_dcn_default/")
parser.add_argument("RCNN0_DETS_DIR", type=str, nargs="?",
                    default="../../models/RelationNetworks/skpeep/unfreeze/output/{}/rcnn_dcn_default/")
parser.add_argument("RCNN1_DETS_DIR", type=str, nargs="?",
                    default="../../models/RelationNetworks/skpeep/default/output/{}/rcnn_dcn_default")
