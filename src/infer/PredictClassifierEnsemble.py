...
BINARY_MODELS_DIR = os.path.join(WDIR, "../../models/classifiers/binary/")
MCLASS_MODELS_DIR = os.path.join(WDIR, "../../models/classifiers/multiclass/")
...
model_ensemble_weights.extend(glob.glob(os.path.join(MCLASS_MODELS_DIR, "*")))
...
pred_df.to_csv(os.path.join(WDIR, "../../ClassifierEnsembleScores.csv", index=False))
