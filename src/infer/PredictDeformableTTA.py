...
JSON_PATH = os.path.join(output_path, yaml_name, test_image_set, "results",
                         "detections_{}_results.json".format(test_image_set))
...
# Rename the detections JSON file so it doesn't get overwritten
FLIP_JSON_PATH = os.path.join(output_path, yaml_name, flip_test_image_set, "results",
                              "detections_{}_results.json".format(flip_test_image_set))
