...
MODELS_DIR = os.path.join(WDIR, "../../models/RetinaNet/output/skippy/")
...
MODEL0_PATH = os.path.join(MODELS_DIR, "fold0_384_resnet101_csv_04.h5")
MODEL1_PATH = os.path.join(MODELS_DIR, "fold1_384_resnet152_csv_05.h5")
MODEL2_PATH = os.path.join(MODELS_DIR, "fold2_384_resnet101_csv_04.h5")
MODEL3_PATH = os.path.join(MODELS_DIR, "fold3_384_resnet152_csv_04.h5")
MODEL4_PATH = os.path.join(MODELS_DIR, "fold4_384_resnet101_csv_06.h5")
MODEL5_PATH = os.path.join(MODELS_DIR, "fold5_384_resnet152_csv_04.h5")
MODEL6_PATH = os.path.join(MODELS_DIR, "fold6_384_resnet101_csv_04.h5")
MODEL7_PATH = os.path.join(MODELS_DIR, "fold7_384_resnet152_csv_04.h5")
MODEL8_PATH = os.path.join(MODELS_DIR, "fold8_384_resnet101_csv_05.h5")
...
df.to_csv(os.path.join(WDIR, "../../RetinaEnsemblePredictions.csv"), index=False)
