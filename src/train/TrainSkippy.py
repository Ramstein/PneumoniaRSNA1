...
STRATIFIED_FOLDS_DF_PATH = os.path.join(WDIR, "../..", SETTINGS_JSON["TRAIN_INFO_DIR"],
                                        "stage_1_stratified_folds_df.csv")
...
def train(fold, backbone,
          ...
          image_min_side=384,
          image_max_side=384,
          annotations_folder=os.path.join(WDIR,
                                          "../../models/RetinaNet/annotations/skippy/fold{}_train_100_0_0_annotations.csv"),
          classes_file_path=os.path.join(WDIR, "../../models/RetinaNet/classes.csv"),
          val_annotations=os.path.join(WDIR,
                                       "../../models/RetinaNet/annotations/skippy/fold{}_pos_valid_annotations.csv")):
    ...
    command += " --image_min_side {} --image_max_side {} csv {}".format(image_min_side, image_max_side,
                                                                        annotations_folder)
